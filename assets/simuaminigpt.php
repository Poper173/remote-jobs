            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link" href="user_languages">language proficiency</a></li>
                        <li class="nav-item"><a class="nav-link" href="who.php">who viewed profile </a></li>
                        <li class="nav-item"><a class="nav-link" href="my_applications.php">📄 View Applications</a>
                        </li>
                    </ul>
                </div>
            </nav>
