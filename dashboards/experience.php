...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO experience (user_id, job_title, company_name, start_date, end_date, description) VALUES (?, ?, ?, ?, ?, ?)");
    if ($stmt->execute([$user_id, $job_title, $company_name, $start_date, $end_date, $description])) {
        header("Location: job_seeker_dashboard.php?experience_added=1");
        exit();
    } else {
...
<head>
    ...
    <title>Add Experience - JobSearch</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-card">
                    <h4 class="text-center text-primary mb-3">Add Job Experience</h4>
